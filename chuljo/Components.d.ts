...
// figma layer: "Control/Category/Text" (node 600:7623)
export interface ControlCategoryTextProps {
  className?: string;
  style?: React.CSSProperties;
  showCount?: boolean;
  enable?: boolean;
...
// figma layer: "출조/홈" (node 411:16309)
...
declare const ControlCategoryText: React.FC<ControlCategoryTextProps>;
...
declare global {
  interface Window {
    ...
    ControlCategoryText: React.FC<ControlCategoryTextProps>;
